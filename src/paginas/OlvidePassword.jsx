      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl  bg-indigo-900'>
        ...
        <nav className='mt-10 lg:flex lg:justify-between'>
          <Link
            ...
            to='/'
          >Ya tienes una cuenta?<span className='text-orange-500 underline'> Inicia Sesion</span>
          </Link>
          <Link
            className='block text-center my-5 text-gray-400'
            to='/registrar'
          >No tienes una cuenta? <span className='text-orange-500 underline'>Registrarse</span>
          </Link>
        </nav>
      </div>
    </>
